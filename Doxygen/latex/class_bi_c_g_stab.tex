...
\index{BiCGStab@{BiCGStab}!inverter@{inverter}}
\index{inverter@{inverter}!BiCGStab@{BiCGStab}}
\subsubsection[{inverter}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class fieldT , class fieldG $>$ static {\bf inversion\_\-stats} BiCGStab::inverter (fieldT \& {\em psi\_\-out}, \/  fieldT \& {\em psi\_\-in}, \/  fieldG \& {\em U}, \/  {\bf coefficients} \& {\em coeff}, \/  {\bf mdp\_\-real} {\em absolute\_\-precision} = {\ttfamily {\bf mdp\_\-precision}}, \/  {\bf mdp\_\-real} {\em relative\_\-precision} = {\ttfamily 0}, \/  int {\em max\_\-steps} = {\ttfamily 2000})\hspace{0.3cm}{\ttfamily  \mbox{[}inline, static\mbox{]}}}}
